...
if(NOT DEFINED FMT_DIR)
  ...
  set(_piper_vendor "${CMAKE_CURRENT_SOURCE_DIR}/vendor")
  if(EXISTS "${_piper_vendor}/fmt-${FMT_VERSION}.zip")
    set(_fmt_url "${_piper_vendor}/fmt-${FMT_VERSION}.zip")
    message(STATUS "piper-plus: using vendored fmt at ${_fmt_url}")
  else()
    set(_fmt_url "https://github.com/fmtlib/fmt/archive/refs/tags/${FMT_VERSION}.zip")
  endif()
  ...
  elseif(EXTERNAL_CMAKE_ARGS)
    # HarmonyOS / parent-injected cross-compile args (see entry piperplus_ohos.cmake)
  else()
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "OHOS" AND EXTERNAL_CMAKE_ARGS)
    # Parent (piperplus_ohos.cmake) already set toolchain for ExternalProject
  elseif(CMAKE_SYSTEM_NAME STREQUAL "OHOS")
    ...
    if(_ohos_native AND EXISTS "${_ohos_native}/build/cmake/ohos.toolchain.cmake")
      list(APPEND EXTERNAL_CMAKE_ARGS
        -DCMAKE_TOOLCHAIN_FILE=${_ohos_native}/build/cmake/ohos.toolchain.cmake
...
if(NOT DEFINED SPDLOG_DIR)
  ...
  if(NOT DEFINED _piper_vendor)
    set(_piper_vendor "${CMAKE_CURRENT_SOURCE_DIR}/vendor")
  endif()
  if(EXISTS "${_piper_vendor}/spdlog-${SPDLOG_VERSION}.zip")
    set(_spdlog_url "${_piper_vendor}/spdlog-${SPDLOG_VERSION}.zip")
    message(STATUS "piper-plus: using vendored spdlog at ${_spdlog_url}")
  else()
    set(_spdlog_url "https://github.com/gabime/spdlog/archive/refs/tags/v${SPDLOG_VERSION}.zip")
  endif()
  ExternalProject_Add(
    spdlog_external
