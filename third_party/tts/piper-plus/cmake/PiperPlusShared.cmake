...
elseif(ANDROID AND DEFINED ONNXRUNTIME_LIB)
  ...
  # Link OpenJTalk static library
  target_link_libraries(piper_plus PRIVATE ${OPENJTALK_DIR}/lib/libopenjtalk.a)
elseif(CMAKE_SYSTEM_NAME STREQUAL "OHOS" AND DEFINED ONNXRUNTIME_LIB)
  # OpenHarmony: reuse Sherpa-bundled libonnxruntime.so
  target_link_libraries(piper_plus PRIVATE
    fmt
    spdlog
    ${ONNXRUNTIME_LIB}
...
# Link pthread and libdl on Linux/Android/OHOS
if(ANDROID)
  target_link_libraries(piper_plus PRIVATE log dl)
elseif(CMAKE_SYSTEM_NAME STREQUAL "OHOS")
  target_link_libraries(piper_plus PRIVATE dl)
...
# HarmonyOS HAP: PIPER_OHOS_NO_SONAME avoids libpiper_plus.so.1 duplicate at ProcessLibs
if(NOT PIPER_APPLE_EMBEDDED AND NOT PIPER_OHOS_NO_SONAME)
  set_target_properties(piper_plus PROPERTIES
